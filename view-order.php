...
$order_id = $_GET['id']; // Assuming you stored the order ID in the session after placing the order

// Fetch client information
$user_sql = "SELECT first_name, last_name, address, phone_number,email FROM users WHERE user_id = '$user_id'";
$user_result = mysqli_query($conn, $user_sql);
$user_info = mysqli_fetch_assoc($user_result);

// Fetch order details
$order_sql = "SELECT total_amount, payment_method, payment_status,created_at,tracking_number FROM orders WHERE order_id = '$order_id'";
    ...
    <div class="container">
        ...
        <div class="row pad-top-botm client-info">
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <br>
                <b>E-mail :</b> <?php echo $user_info['email']; // Assuming you have stored user email in session 
                                ?>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                Delivery Date : <?php echo date('d F Y', strtotime($order_info['created_at'] . ' + 3 days')); // Assuming delivery is 7 days after order date 
                                ?>
                <br>
                Payment Method : <?php echo $order_info['payment_method'] // Assuming delivery is 7 days after order date 
                                    ?><br>
                Tracking No : <?php echo $order_info['tracking_number']; ?>
                <br>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="ttl-amts">
                    ...
                    <h5> Discounted Amount : Rs. <?php echo $total_amount - $order_info['total_amount']; ?> </h5>
                </div>
                <hr>
                <hr>
                <div class="ttl-amts">
